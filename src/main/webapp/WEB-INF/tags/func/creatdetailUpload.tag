...
var commonUploadType = "";
var commonUploadCode = "";
var commonUploadCustId = "";

$(document).ready(function() {

	$('#commonUploadModal').on('show.bs.modal', function (e) {

	    $(this).find('.modal-body').load("${uploadOpenUrl}?type=" + commonUploadType + "&code=" + commonUploadCode + "&custId=" + commonUploadCustId);
...
function openUploadModal(type, title, code, custId) {
