...
<c:url value="/fnd/priv/create" var="createUrl" />
<c:url value="/fnd/priv/read" var="readUrl" />
<c:url value="/fnd/priv/update" var="updateUrl" />
<c:url value="/fnd/priv/destroy" var="destroyUrl" />
...
$(document).ready(function() {
	...
	$("#delete-btn").click(function(e) {
		...
		rows.each(function(index, row) {
			...
			if (selectedItem.ukid.indexOf(".") > -1) {
				delNotAllowed = true;
			}
		});
		
		if (delNotAllowed) {
			showAlertModal("danger", "대상 자료는 시스템에서 내부적으로 사용되고 있으며, 삭제할 수 없습니다.");
			return;
		}
		...
		<form class="modal-content" id="form-1" rowid="-1" url="${createUrl}">
			...
			<div class="modal-body modal-bg-color">
				<div class="form-group col">
					...
					<input name="ukid" type="text" maxlength="30" class="form-control required">
				</div>
				<div class="form-group col">
					<label class="form-label">
						권한명
					...
					<input name="name" type="text" maxlength="25" class="form-control required">
				</div>
			</div>
