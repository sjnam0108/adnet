...
<c:url value="/fnd/viewtype/create" var="createUrl" />
<c:url value="/fnd/viewtype/read" var="readUrl" />
<c:url value="/fnd/viewtype/update" var="updateUrl" />
<c:url value="/fnd/viewtype/destroy" var="destroyUrl" />

<c:url value="/fnd/viewtype/readACMedia" var="readACMediumUrl" />
...
<kendo:grid name="grid" pageable="true" filterable="true" scrollable="false" reorderable="true" resizable="true">
	...
	<kendo:grid-columns>
		...
		<kendo:grid-column title="묶음 광고 단위" field="adPackUsed"
				template="#=adPackUsed ? \"<span class='fa-light fa-check'>\" : \"\"#" />
	</kendo:grid-columns>
		...
		<kendo:dataSource-schema data="data" total="total" groups="data">
			<kendo:dataSource-schema-model id="id">
				<kendo:dataSource-schema-model-fields>
					<kendo:dataSource-schema-model-field name="adPackUsed" type="boolean" />
				</kendo:dataSource-schema-model-fields>
				...
				<div class="form-group col">
					...
					<div class="pt-1">
						<label class="switcher switcher-lg">
							<input type="checkbox" class="switcher-input" name="adPackUsed">
