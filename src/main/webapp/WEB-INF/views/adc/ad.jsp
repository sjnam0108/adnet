    ...
    <kendo:grid name="grid" pageable="true" filterable="true" scrollable="true" reorderable="true"
        ...
        <kendo:grid-toolbarTemplate>
            <div class="clearfix">
                ...
                <div class="float-right">
                    <button id="duplicate-btn" type="button" class="btn btn-outline-success d-none d-sm-inline">복사 추가
                    </button>
        ...
        <kendo:grid-columns>
                ...
                <kendo:grid-column-filterable multi="true" itemTemplate="kfcIconText">
                    <kendo:dataSource>
                        <kendo:dataSource-transport>
                            <kendo:dataSource-transport-read url="${readStatusUrl}" dataType="json" type="POST"
            ...
            <kendo:grid-column title="구매 유형" field="purchType" width="120" template="<%= purchTypeTemplate %>">
                <kendo:grid-column-filterable multi="true" itemTemplate="kfcIconText">
                    <kendo:dataSource>
                        <kendo:dataSource-transport>
                            <kendo:dataSource-transport-read url="${readPurchTypeUrl}" dataType="json" type="POST"
                                                             contentType="application/json"/>
                        </kendo:dataSource-transport>
                    </kendo:dataSource>
                </kendo:grid-column-filterable>
            ...
            <kendo:grid-column title="집행방법" field="goalType" width="120" template="<%= goalTypeTemplate %>">
                <kendo:grid-column-filterable multi="true" itemTemplate="kfcIconText">
                    <kendo:dataSource>
                        <kendo:dataSource-transport>
                            <kendo:dataSource-transport-read url="${readGoalTypeUrl}" dataType="json" type="POST"
                                                             contentType="application/json"/>
                        </kendo:dataSource-transport>
                    </kendo:dataSource>
                </kendo:grid-column-filterable>
            ...
            <kendo:grid-column title="일별 분산" field="impDailyType" width="120" template="<%= impDailyTypeTemplate %>">
                <kendo:grid-column-filterable multi="true" itemTemplate="kfcIconText">
                    <kendo:dataSource>
                        <kendo:dataSource-transport>
                            <kendo:dataSource-transport-read url="${readImpDailyTypeUrl}" dataType="json" type="POST"
                                                             contentType="application/json"/>
                        </kendo:dataSource-transport>
                    </kendo:dataSource>
                </kendo:grid-column-filterable>
            ...
            <kendo:grid-column title="하루 분산" field="impHourlyType" width="120" template="<%= impHourlyTypeTemplate %>">
                <kendo:grid-column-filterable multi="true" itemTemplate="kfcIconText">
                    <kendo:dataSource>
                        <kendo:dataSource-transport>
                            <kendo:dataSource-transport-read url="${readImpHourlyTypeUrl}" dataType="json" type="POST"
                                                             contentType="application/json"/>
                        </kendo:dataSource-transport>
                    </kendo:dataSource>
                </kendo:grid-column-filterable>
            ...
            <kendo:grid-column title="최근 변경" field="whoLastUpdateDate" width="120"
                               template="<%= lastUpdateDateTemplate %>"/>
        ...
        <kendo:dataSource serverPaging="true" serverSorting="true" serverFiltering="true" serverGrouping="true"
            ...
            <kendo:dataSource-filter>
                <kendo:dataSource-filterItem field="medium.id" operator="eq" logic="and"
                                             value="${sessionScope['currMediumId']}">
                ...
                <div class="modal-body modal-bg-color">
                    <div class="form-row">
                        ...
                        <div class="form-group col">
                            ...
                            <select name="campaign" class="selectpicker bg-white" data-live-search="true"
                                    style="width: 200px"
                    ...
                    <div class="form-row">
                        <div class="form-group col">
                            ...
                            <select name="purchType" class="selectpicker bg-white" data-style="btn-default"
                                    data-tick-icon="fa-blank" data-none-selected-text="">
                                <option value="G" data-icon="fa-regular fa-hexagon-check text-blue fa-fw mr-1">목표 보장
                                </option>
                                <option value="N" data-icon="fa-regular fa-hexagon-exclamation fa-fw mr-1">목표 비보장
                                </option>
                        ...
                        <div class="form-group col">
                            <label class="form-label">
                                ...
                                <span data-toggle="tooltip" data-placement="right"
                                      title="최고 1에서 최저 10 사이의 값을 선택해 주세요. 기본 선택값은 5입니다.">
								<span class="fa-regular fa-circle-info text-info"></span>
							</span>
                            </label>
                            <div class="slider-primary">
                                <input name="priority" type="text" data-slider-min="1" data-slider-max="10"
                    ...
                    <div class="form-row" name="purch-type-depending-div">
                        ...
                        <div class="form-group col">
                            ...
                            <div class="input-group">
                                <input name="goalValue" type="text" value="0"
                                       class="form-control input-change required">
                                <div class="input-group-append">
                    ...
                    <div class="form-row" name="purch-type-depending-div">
                        <div class="form-group col">
                            <label class="form-label">
                                집행 방법
                                <span data-toggle="tooltip" data-placement="right"
                                      title="광고 예산과 보장/목표 노출량 값에 따라 집행 방법이 결정됩니다.">
								<span class="fa-regular fa-circle-info text-info"></span>
							</span>
                            </label>
                            <select name="goalType" class="selectpicker bg-white" data-style="btn-default"
                                    data-tick-icon="fa-blank" data-none-selected-text="" disabled>
                        ...
                        <div class="form-group col">
                            ...
                            <select name="impDailyType" class="selectpicker bg-white" data-style="btn-default"
                                    data-tick-icon="fa-blank" data-none-selected-text="">
                                <option value="E" data-icon="fa-regular fa-equals fa-fw mr-1">모든 날짜 균등</option>
                                <option value="W" data-icon="fa-regular fa-bars-staggered fa-fw mr-1">통계 기반 요일별 차등
                                </option>
                            </select>
                        </div>
                        <div class="form-group col">
                            ...
                            <select name="impHourlyType" class="selectpicker bg-white" data-style="btn-default"
                                    data-tick-icon="fa-blank" data-none-selected-text="">
                    ...
                    <div class="form-row">
                        <div class="form-group col">
                            ...
                            <select name="impAddRatio" class="selectpicker bg-white" data-style="btn-default"
                                    data-tick-icon="fa-blank" data-none-selected-text="">
                        ...
                        <div class="form-group col">
                            ...
                            <select name="viewType" class="selectpicker bg-white" data-style="btn-default"
                                    data-tick-icon="fa-blank" data-none-selected-text="">
                        ...
                        <div class="form-group col" name="purch-type-depending-div">
                            ...
                            <select name="cpmType" class="selectpicker bg-white" data-style="btn-default"
                                    data-tick-icon="fa-blank" data-none-selected-text="">
                    ...
                    <div class="form-row">
                        <div class="form-group col">
                            ...
                            <select name="dailyCapType" class="selectpicker bg-white" data-style="btn-default"
                                    data-tick-icon="fa-blank" data-none-selected-text="">
                        ...
                        <div class="form-group col">
                            ...
                            <select name="freqCapType" class="selectpicker bg-white" data-style="btn-default"
                                    data-tick-icon="fa-blank" data-none-selected-text="">
                                <option value="0" data-icon="fa-regular fa-earth-asia fa-fw mr-1">매체
                                    설정값(${mediumFreqCapAd}) 적용
                                </option>
                    ...
                    <div class="form-row">
                        <div class="form-group col">
                            ...
                            <select name="dailyScrCapType" class="selectpicker bg-white" data-style="btn-default"
                                    data-tick-icon="fa-blank" data-none-selected-text="">
                                <option value="0" data-icon="fa-regular fa-earth-asia fa-fw mr-1">매체
                                    설정값(${mediumDailyScrCap}) 적용
                                </option>
                                <option value="1" data-icon="fa-regular fa-input-numeric fa-fw mr-1">값 지정</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group col">
                            ...
                            <select name="durationType" class="selectpicker bg-white" data-style="btn-default"
                                    data-tick-icon="fa-blank" data-none-selected-text="">
                                <option value="0" data-icon="fa-regular fa-screen-users fa-fw mr-1">화면 설정값 기준</option>
                                <option value="5" data-icon="fa-regular fa-input-numeric fa-fw mr-1">값 지정</option>
                            </select>
