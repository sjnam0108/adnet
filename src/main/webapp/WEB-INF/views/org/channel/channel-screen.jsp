...
<c:url value="/org/channel/screen/read" var="readUrl" />

<c:url value="/org/channel/screen/createWithNames" var="createWithNameUrl" />
<c:url value="/org/channel/screen/createWithShortNames" var="createWithShortNameUrl" />
<c:url value="/org/channel/screen/destroy" var="destroyUrl" />
...
<ul class="nav nav-tabs tabs-alt mb-4 mt-3">
	<li class="nav-item">
		<a class="nav-link active" href="/org/channel/screen/${Channel.id}">
...
$(document).ready(function() {
	...
	$("select[name='nav-item-chan-select']").on("change.bs.select", function(e){
		location.href = "/org/channel/screen/" + $("select[name='nav-item-chan-select']").val();
	});
