...
<kendo:grid name="grid-ad" pageable="true" scrollable="true" filterable="false" sortable="false" resizable="true" selectable="multiple" >
...
<kendo:grid name="grid-screen-daily" pageable="true" scrollable="true" sortable="true" filterable="true" resizable="true" selectable="multiple" >
