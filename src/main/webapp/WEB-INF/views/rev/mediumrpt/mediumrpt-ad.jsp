...
<c:url value="/rev/mediumrpt/ad/readOverview" var="readOverviewUrl" />
<c:url value="/rev/mediumrpt/ad/read" var="readUrl" />
...
function navigateToDate(date) {
	...
	showWaitModal();
	location.href = "/rev/mediumrpt/ad?date=" + date;
}
...
<ul class="nav nav-tabs tabs-alt mb-4 mt-4">
	...
	<li class="nav-item">
		<a class="nav-link active" href="javascript:navigateToAd();">
	...
	String ovwNameTemplate =
			"<div>" + 
				...
				"# } else { #" +
					...
					"# } # " +
					"<a href='javascript:navToRptAd(#= campId #, #= id #)'><span class='text-link'>#= name #</span></a>" +
				"# } #" +
				"# if (mobTargeted == true) { #" +
	...
	String nameTemplate =
			"<div>" + 
				"# if (totalRow) { #" +
					"<span class='accent'>#= name #</span>" + 
				"# } else { #" +
					"<a href='javascript:navToRptAd(#= parentId #, #= dataId #)'><span class='text-link'>#= name #</span></a>" +
				"# } #" +
			"</div>";
