    ...
    <kendo:grid name="grid" pageable="true" filterable="true" scrollable="true"
        ...
        <kendo:dataSource serverPaging="true" serverSorting="true" serverFiltering="true" serverGrouping="true"
            ...
            <kendo:dataSource-transport>
                <kendo:dataSource-transport-read url="${readPAUrl}" dataType="json" type="POST"
...
<div class="mb-4">
    ...
    <kendo:grid name="grid-decn" pageable="true" filterable="true" scrollable="true"
        ...
        <kendo:grid-columns>
            ...
            <kendo:grid-column title="어떻게?" field="status" width="120" template="<%= actStatusTemplate %>">
                <kendo:grid-column-filterable multi="true" itemTemplate="kfcIconText">
                    <kendo:dataSource>
                        <kendo:dataSource-transport>
                            <kendo:dataSource-transport-read url="${readActStatusUrl}" dataType="json" type="POST"
                                                             contentType="application/json"/>
                        </kendo:dataSource-transport>
                    </kendo:dataSource>
                </kendo:grid-column-filterable>
            </kendo:grid-column>
            <kendo:grid-column title="누가?" field="actedBy" width="120" filterable="false"
                               template="#= actedByShortName #"/>
        ...
        <kendo:dataSource serverPaging="true" serverSorting="true" serverFiltering="true" serverGrouping="true"
            ...
            <kendo:dataSource-transport>
                <kendo:dataSource-transport-read url="${readCreatDecnUrl}" dataType="json" type="POST"
                                                 contentType="application/json"/>
                <kendo:dataSource-transport-parameterMap>
                    <script>
                        function parameterMap(options, type) {
