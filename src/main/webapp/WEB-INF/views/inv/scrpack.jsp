...
<c:url value="/inv/scrpack/create" var="createUrl" />
<c:url value="/inv/scrpack/update" var="updateUrl" />
<c:url value="/inv/scrpack/read" var="readUrl" />
<c:url value="/inv/scrpack/destroy" var="destroyUrl" />
...
function navToScrList(packId) {
	var path = "/inv/scrpack/screen/" + packId;
	location.href = path;
}
