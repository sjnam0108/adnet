package kr.adnetwork.controllers.sys;
...
import kr.adnetwork.controllers.rev.RevGeofenceController;
...
import kr.adnetwork.viewmodels.sys.SysAdSelItem;
    ...
    public @ResponseBody List<SysAdSelItem> readHourly(@RequestBody DataSourceRequest request, 
    	...
    	try {
    		...
    		for(Tuple tuple : hourList2) {
    			...
    			retList.add(new SysAdSelItem(kr.adnetwork.utils.Util.parseDate(timeStr + "00"),
