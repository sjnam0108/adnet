...
import net.doohad.models.inv.InvRTScreenView;
...
import net.doohad.viewmodels.rev.RevMonitCurrStatItem;
import net.doohad.viewmodels.rev.RevSyncPackCurrStatItem;
